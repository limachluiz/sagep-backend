    ...
    schemas: {
      ...
      ProjectFlowUpdateRequest: {
        ...
        properties: {
          ...
          creditNotes: {
            ...
            items: {
              type: "object",
              required: ["number", "receivedAt", "amount"],
              properties: {
                number: { type: "string", minLength: 3 },
                receivedAt: { type: "string", format: "date-time" },
                amount: { type: "number", exclusiveMinimum: 0 },
                issuingManagementUnit: { type: "string", nullable: true },
                fundingSource: { type: "string", nullable: true },
                ptres: { type: "string", nullable: true },
                expenseNature: { type: "string", nullable: true },
                internalPlan: { type: "string", nullable: true },
                documentLink: { type: "string", format: "uri", nullable: true },
      ...
      ServiceOrder: {
        ...
        properties: {
          ...
          requesterCpf: { type: "string", nullable: true },
          requesterRole: { type: "string", nullable: true },
          hasProjectInspector: { type: "boolean" },
          projectInspectorName: { type: "string", nullable: true },
          projectInspectorRank: { type: "string", nullable: true },
          projectInspectorCpf: { type: "string", nullable: true },
          projectInspectorRole: { type: "string", nullable: true },
          issuingOrganization: { type: "string", nullable: true },
      ...
      ServiceOrderCreateRequest: {
        ...
        properties: {
          ...
          requesterRank: { type: "string", nullable: true },
          requesterRole: { type: "string", nullable: true },
          hasProjectInspector: { type: "boolean", nullable: true },
          projectInspectorName: { type: "string", nullable: true },
          projectInspectorRank: { type: "string", nullable: true },
          projectInspectorCpf: { type: "string", nullable: true },
          projectInspectorRole: { type: "string", nullable: true },
      ...
      Ata: {
        ...
        properties: {
          ...
          vendorCnpj: { type: "string", nullable: true },
              ...
              properties: {
                ...
                commitments: {
                  ...
                  items: {
                    type: "object",
                    properties: {
                      number: { type: "string" }, unit: { type: "string" }, supplier: { type: "string" },
                      commitmentDate: { type: "string" }, includedQuantity: { type: "string" },
                      reinforcementQuantity: { type: "string" }, annulledQuantity: { type: "string" },
                      committedQuantity: { type: "string" }, value: { type: "string" },
                      transparencyUrl: { type: "string", format: "uri" },
                    },
                  },
                },
      ...
      AtaCreateRequest: {
        ...
        properties: {
          ...
          vendorCnpj: { type: "string", pattern: "^\\d{14}$", nullable: true },
          managingAgency: { type: "string", nullable: true },
          validFrom: { type: "string", format: "date-time", nullable: true },
          validUntil: { type: "string", format: "date-time", nullable: true },
          notes: { type: "string", nullable: true },
        ...
        properties: {
          ...
          balance: {
            ...
            properties: {
              ...
              totalConsumedQuantity: { type: "string", description: "Consumo total, somando carga histórica e consumo operacional do SAGEP." },
              ...
              totalConsumedAmount: { type: "string", description: "Valor consumido total, incluindo o saldo histórico de abertura." },
