...
systemSettingsRoutes.post("/connections/test", sensitiveRateLimiter, requirePermission("settings.manage"), (req, res) => controller.testAll(req, res));
systemSettingsRoutes.post("/connections/:provider/test", sensitiveRateLimiter, requirePermission("settings.manage"), (req, res) => controller.testOne(req, res));
