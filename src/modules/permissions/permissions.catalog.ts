...
export const permissionDescriptions: Record<Permission, string> = {
  ...
  "projects.delete": "Permite excluir logicamente projetos arquivados ou ainda não iniciados",
  ...
  "estimates.delete": "Permite excluir logicamente estimativas arquivadas ou canceladas",
